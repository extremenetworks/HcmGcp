...
public class BillingRes {
    ...
    @GET
    @Path("all")
    public String retrieveAllBilling(
    		@QueryParam("projectId") String projectId) {
    	
    	String dbBillingData = retrieveDataFromDb(projectId);
        
        return dbBillingData;
    }
    ...
    public String triggerUpdateAll(
    	...
    	try {
    		...
    		logger.debug("Creating background worker to import billing data from GPC project " + projectId);

    		
    		executor.execute(new BillingWorker(
